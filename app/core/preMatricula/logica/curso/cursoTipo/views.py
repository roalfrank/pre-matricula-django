...
class TipoCursoView(LoginRequiredMixin, ValidatePermissionRequiredCrudSimpleMixin, TemplateView):
    template_name = "curso/cursoTipo/list.html"
    permiso_vista = 'view_tipogrupo'
    permiso_crud = {
        'add': 'add_tipogrupo',
        'change': 'change_tipogrupo',
        'delete': 'delete_tipogrupo',
    }
        ...
        try:
            ...
            # action chequear , esto es para comprobar rapido si ya hay otra  con el Mismo Nombre
                ...
                try:
                    ...
                    estado = TipoGrupo.objects.filter(
            ...
            # Action  cargarDatos - para cargar la datatable de mi vista.
                ...
                data = [i.toJson() for i in TipoGrupo.objects.all()]
                respuesta = JsonResponse(data, safe=False)
                return respuesta
            # action edit - editando una entidad.
            elif action == 'edit':
                registro = TipoGrupo.objects.get(
            ...
            # action delete, eliminar una registro
                ...
                try:
                    ...
                    delet_registro = TipoGrupo.objects.filter(
                        pk__in=id_deletes)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = "Lista de Tiipo de Curso"
        context['icono_titulo'] = "fas fa-tachometer-alt"
        context['form'] = TipoCursoForm()
        return context
