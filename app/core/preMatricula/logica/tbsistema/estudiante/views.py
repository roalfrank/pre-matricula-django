...
class EstudianteView(LoginRequiredMixin, ValidatePermissionRequiredCrudSimpleMixin, TemplateView):
    template_name = "tbsistema/estudiante/list.html"
        ...
        try:
            ...
            #action chequearEstado , esto es para comprobar rapido si ya hay otra provincia con el Mismo Nombre
                ...
                try:
                    ...
                    estado = Estudiante.objects.filter(
            ...
            #action edit - editando una provincia.
                ...
                registro = Estudiante.objects.get(
                    pk=int(request.POST['id_edit']))
                form = EstudianteForm(request.POST, instance=registro)
                if form.is_valid():
                    form.save()
                    data['enviado'] = True
                    data['nombre'] = request.POST['nombre']
            ...
            #action delete, eliminar una registro
                ...
                try:
                    ...
                    delet_registro = Estudiante.objects.filter(
                        pk__in=id_deletes)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = "Lista de Estudiante"
