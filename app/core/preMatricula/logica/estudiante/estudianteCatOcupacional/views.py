...
from .form import CategoriaOcupacionalEstudianteForm
from core.preMatricula.mixis import ValidatePermissionRequiredCrudSimpleMixin


class CategoriaOcupacionalEstudianteView(LoginRequiredMixin, ValidatePermissionRequiredCrudSimpleMixin, TemplateView):
    template_name = "estudiante/estudiante-cat-ocupacional/list.html"
    permiso_vista = 'view_categoriaocupacional'
    permiso_crud = {
        'add': 'add_categoriaocupacional',
        'change': 'change_categoriaocupacional',
        'delete': 'delete_categoriaocupacional',
    }
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'add':
                form = CategoriaOcupacionalEstudianteForm(request.POST)
                if form.is_valid():
                    form.save()
                    data['enviado'] = True
            ...
            # action chequear , esto es para comprobar rapido si ya hay otra  con el Mismo Nombre
                ...
                try:
                    ...
                    estado = CategoriaOcupacional.objects.filter(
            ...
            # Action  cargarDatos - para cargar la datatable de mi vista.
                ...
                data = [i.toJson() for i in CategoriaOcupacional.objects.all()]
                respuesta = JsonResponse(data, safe=False)
                return respuesta
            # action edit - editando una entidad.
            elif action == 'edit':
                registro = CategoriaOcupacional.objects.get(
                    pk=int(request.POST['id_edit']))
                form = CategoriaOcupacionalEstudianteForm(
            ...
            # action delete, eliminar una registro
                ...
                try:
                    ...
                    delet_registro = CategoriaOcupacional.objects.filter(
                        pk__in=id_deletes)
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = "Lista de Categoría Ocupacional de Estudiante"
        context['icono_titulo'] = "fas fa-tachometer-alt"
        context['form'] = CategoriaOcupacionalEstudianteForm()
        return context
