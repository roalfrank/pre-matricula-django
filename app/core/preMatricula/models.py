...
class Entidad(models.Model):
    ...
    municipio = models.ForeignKey(Municipio,verbose_name="Municipio",on_delete=models.SET_NULL,null=True,blank=True)
...
class Region(models.Model):
    ...
    jcp= models.ForeignKey(JCP,verbose_name="Joven Club Provincial", on_delete=models.CASCADE)
...
class Maestro(models.Model):
    instructor = models.OneToOneField(Instructor,on_delete=models.CASCADE,verbose_name='Instructor')
...
class Estudiante(models.Model):
    usuario_sisce = models.CharField(max_length=30,verbose_name='Usuario del siscae',null=True,blank=True)
...
class Curso(models.Model):
    ...
    nextCurso = models.ForeignKey('preMatricula.Curso',on_delete=models.SET_NULL,null=True,blank=True)
...
class EstadoMatricula(models.Model):
    nombre = models.CharField(
        max_length=50, verbose_name='Nombre de la Estado Matricula')
...
class PreMatricula(models.Model):
    ...
    estado = models.ForeignKey(EstadoMatricula,on_delete=models.RESTRICT,verbose_name='Estado de la PreMatricula')
...
class Comentario(models.Model):
    ...
    preMatricula = models.ForeignKey(PreMatricula,on_delete=models.CASCADE, verbose_name='Pre matricula')
...
class CursoInteres(models.Model):
    ...
    curso = models.ForeignKey(Curso,on_delete=models.CASCADE,verbose_name='Curso de Interes')
