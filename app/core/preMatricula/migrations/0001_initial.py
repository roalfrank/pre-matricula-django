    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(blank=True, default='curso_default.png', null=True, upload_to='curso/foto', verbose_name='Foto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preMatricula', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='preMatricula.prematricula', verbose_name='Pre matricula')),
                ('respuestaA', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='preMatricula.comentario', verbose_name='Respuesta a')),
